...
export const EXPERIENCE: IJobPosition[] = [
  {
    ...
    company: "Alsomine",
    description: [
      "Building Rest API using NestJS with OpenAPI",
      "NextJS project configuration with webpack and babel",
      "Working with AWS infratracture with terraform",
      "Building complex website with NextJS from scratch",
